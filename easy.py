...
with gr.Blocks(
    title="🔊", theme=gr.themes.Base(primary_hue="emerald", neutral_hue="zinc")
) as app:
    with gr.Row():
            ...
            with gr.Row():
                with gr.Column():
                    with gr.Row():
                        ...
                        dwnl_button.click(
                            fn=download_audio, inputs=[url, audio_name], outputs=[url]
                        )
                ...
                with gr.Column():
                    ...
                    with gr.Accordion("General Settings", open=False):
                        f0method0 = gr.Radio(
                            label="Method",
                            choices=(
                                ["crepe", "rmvpe"] if config.dml == False else ["rmvpe"]
                            ),
                            value="rmvpe",
                            interactive=True,
                        )
